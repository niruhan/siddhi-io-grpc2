...
public class MessageParser {
    ...
    private final Attribute.Type siddhiAttributeType;
    private final Map<Integer, Descriptors.FieldDescriptor> fieldDescriptors;

    public MessageParser(String messageName, Attribute.Type siddhiAttributeType) {
        this.messageName = messageName;
        this.siddhiAttributeType = siddhiAttributeType;
    ...
    Message parseFrom(CodedInputStream input) throws IOException {
        return new Message(messageName, siddhiAttributeType, input, fieldDescriptors);
    }
